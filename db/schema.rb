...
ActiveRecord::Schema.define(version: 20170513162656) do
  ...
  create_table "beekeepers", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.text     "text",       limit: 65535
    t.string   "title"
    t.text     "url1",       limit: 65535
    t.text     "url2",       limit: 65535
    t.text     "url3",       limit: 65535
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.string   "image"
    t.string   "image1"
